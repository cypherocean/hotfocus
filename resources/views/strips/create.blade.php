        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form name="form" action="{{ route('strips.insert') }}" id="form" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" name="choke" id="choke" class="form-control" placeholder="Plese enter choke per unit" value="{{ @old('choke') }}" />
