...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        if ($('#data-table').length > 0) {
            datatable = $('#data-table').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('payments.reminders')); ?>",
                    "type": "POST",
                    "dataType": "json",
                    // "data":{
        ...
        if (id) {
            $.ajax({
                url: '<?php echo route("payment.add.followup"); ?>',
                type: "POST",
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
                    id: id
        ...
        if (name) {
            $.ajax({
                url: '<?php echo route("payment.followup.details"); ?>',
                type: "POST",
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
                    name: name,
        ...
        if (name) {
            $.ajax({
                url: '<?php echo route("payment.bill.details"); ?>',
                type: "POST",
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
                    name: name,
    ...
    $(document).on("submit", ".form", function(e) {
        ...
        $.ajax({
            "url": "<?php echo route('payments.reminders.insert'); ?>",
            "dataType": "json",
            "type": "POST",
            "data": {
    ...
    function change_status(object) {
        ...
        if (confirm(msg)) {
            $.ajax({
                "url": "<?php echo route('payments.reminders.change.status'); ?>",
                "dataType": "json",
                "type": "POST",
                "data": {
                    id: id,
    ...
    function _reports(page) {
        $.ajax({
            "url": "<?php echo route('payments.reminders.reports'); ?>" + "?page=" + page,
            "dataType": "json",
            "type": "Get",
            success: function(response) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ami-enterprise\resources\views/payment_reminder/index.blade.php ENDPATH**/ ?>