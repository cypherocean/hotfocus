    ...
    <div class="page-content fade-in-up">
        <div class="row">
            <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Create Strip Light</div>
                    </div>
                    <div class="ibox-body">
                        <form name="form" action="<?php echo e(route('strips.insert')); ?>" id="form" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" name="quantity" id="quantity" class="form-control" placeholder="Plese enter quantity" value="<?php echo e(@old('quantity')); ?>" />
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" name="choke" id="choke" class="form-control" placeholder="Plese enter choke per unit" value="<?php echo e(@old('choke')); ?>" />
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\work\ami-enterprise\resources\views/strips/create.blade.php ENDPATH**/ ?>